...
<img src="../../img/wpp/whatsapp-banner.jpg" alt="WhatsApp banner" width="100%"/>

WhatsApp é um aplicativo multiplataforma de mensagens instantâneas e chamadas de voz para smartphones. Além de mensagens de texto, os usuários podem enviar imagens, vídeos, áudios e documentos em PDF.

>Se você acabou de ativar sua conta PRO deve esperar um pouco até que seu ambiente WhatsApp seja criado, você receberá uma notificação informando quando estiver concluído, esse processo demora em média, aproximadamente 10 minutos.
